...
job_name="fsl_dr-ica"
log_dir="/ceph/chpc/shared/janine_bijsterbosch_group/naranjorincon_scratch/NeuroTranslate/ty_script_ABCD_ICA/FSL_slurm/logs"
mem_gb=50
partition="janine_bijsterbosch" #"small" # tier CPU TODO
